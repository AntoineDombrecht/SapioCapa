...
- Attention
```
**TOUT DEPLACEMENT EST IRREVERSIBLE** Les mails traités le sont depuis la boite de réception uniquement. Dès lors qu'un mail est déplacé ailleurs, il va de soi qu'il ne pourra plus être pris en compte lors les futures opérations. 
